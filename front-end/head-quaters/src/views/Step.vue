...
<div>
  ...
  <v-stepper v-model="e1">
    <v-stepper-header class="white" >
      <v-stepper-step class="white--text"  :complete="e1 > 1" step="1">{{userData.complainants}}</v-stepper-step>
      <!-- <v-divider></v-divider>
      ...
      <v-stepper-content  step="1">
        <v-container>
          ...
          <!-- <v-container> -->
            ...
            <v-layout>
             ...
             <v-layout>
              ...
              <v-flex xs12 md8>
                  <p  class="left mx-2 ">{{userData.levels}}</p>
              </v-flex>
            </v-layout>
            <v-layout>
              <v-flex xs12 md4>
          ...
          <v-layout>
              ...
              <v-flex xs12 md8>
                  <p  class="left mx-2 ">{{userData.resolving}}</p>
              </v-flex>
            </v-layout>
          <!-- <v-container> -->
